...
4. **Replace priority dropdown with 4-way button toggle** — For new task form and edit task form, change priority from a dropdown to a four-way button toggle. (Direction from Jordan, 2026-02-12. "Still needs be implemented.")
